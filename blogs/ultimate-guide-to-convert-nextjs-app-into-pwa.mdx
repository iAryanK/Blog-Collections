...
<div align="center">
    <a href="https://www.iaryan.tech" target="_blank">
      <img src="https://miro.medium.com/v2/resize:fit:1000/0*TMmvFXObXEKuOBBF.jpg" alt="next pwa"/>
    </a>

  <h4 align="center">Visit my portfolio website <a href="https://www.iaryan.tech" target="_blank"><b>www.iaryan.tech</b></a> which is now a PWA!</h4>
</div>
...
<br/>
<br/>
👉 <strong>Cost Effective</strong>: As a developer, we can create websites and convert it into a PWA to get both app and website for our product.
...
<br/>
<br/>
👉 <strong>Liimited functionality</strong>: Compared to native apps, PWAs may not fully access some device features like geofencing, or advanced sensors, limiting their capabilities. Although, they can access various sensors.
